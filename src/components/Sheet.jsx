...
export default function Sheet({ open, onClose, children }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center overscroll-none">
      ...
      <div className="relative w-full md:w-[400px] max-h-[calc(100dvh-8px)] overflow-y-auto overscroll-contain bg-surface border border-border md:rounded-3xl rounded-t-3xl p-6 pb-[calc(env(safe-area-inset-bottom)+24px)] md:pb-6 animate-sheet-up md:animate-rise no-scrollbar">
